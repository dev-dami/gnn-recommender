...
- **LightGCN** — He et al. (2020), *LightGCN: Simplifying and Powering Graph Convolution Network for Recommendation* (SIGIR 2020)  
  https://arxiv.org/abs/2002.02126

- **UltraGCN** — Mao et al. (2021), *UltraGCN: Ultra Simplification of Graph Convolutional Networks for Recommendation* (CIKM 2021)  
  https://arxiv.org/abs/2110.15114

- **BPR** — Rendle et al. (2009), *BPR: Bayesian Personalized Ranking from Implicit Feedback* (UAI 2009)  
  https://arxiv.org/abs/1205.2618

- **SimGCL** — Yu et al. (2022), *Are Graph Augmentations Necessary? Simple Graph Contrastive Learning for Recommendation* (SIGIR 2022)  
  https://arxiv.org/abs/2202.02126
